    ...
    <div class="toolbar">
      ...
      <div id="tb" style="float: right;">
        ...
        <div id="search_menu" style="width:100px;">
          ...
          <div data-options="name:'payWayId'">支付ID</div>
          <div data-options="name:'payWayName'">支付名称</div>
...
//        }
    ...
    $("#games").datagrid({
      height:460,
      url:'<%=basePath%>/admin/payway/getAllPayWay',
      method:'POST',
      idField:'payWayId',
      striped:true,
      fitColumns:true,
      ...
      showFooter:true,
      columns:[[
        {field:'payWayId', title:'支付ID', width:40, sortable:true},
        {field:'payWayName', title:'支付名称', width:40, sortable:true},
