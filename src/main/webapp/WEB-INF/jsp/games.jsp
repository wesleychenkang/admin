...
<body>
  ...
  <div id="dialog_detail" class="easyui-dialog u8_form"
    ...
    <form id="fm_edit" method="post" novalidate>
      ...
      <div class="u8_form_row">
        <label >游戏名称：</label>
        <input type="text" class="easyui-textbox" style="height: 25px;" name="name" readonly="readonly" novalidate/>
      </div>

      <div class="u8_form_row">
        <label >AppID：</label>
        <input type="text" class="easyui-textbox" style="height: 25px;" name="appID" readonly="readonly" novalidate/>
      </div>

      <div class="u8_form_row">
        <label >AppKey：</label>
        <input type="text" class="easyui-textbox" style="height: 25px;" name="appkey" readonly="readonly" novalidate/>
      </div>

      <div class="u8_form_row">
        <label >AppSecret：</label>
        <input type="text" class="easyui-textbox" style="height: 25px;" name="appSecret" readonly="readonly" novalidate/>
      </div>
      
      <div class="u8_form_row">
        <label >支付回调地址：</label>
        <input type="text" class="easyui-textbox" style="height: 25px;" name="payCallback" readonly="readonly" novalidate/>
      </div>
    </form>
  </div>
