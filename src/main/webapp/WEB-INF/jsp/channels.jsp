...
<div id="dialog_add" class="easyui-dialog u8_form"
  ...
  <form id="fm" method="post" novalidate>
    ...
    <div class="u8_form_row">
      <label >渠道号：</label>
      <input id="channel" type="text" value="111" class="easyui-textbox" style="height: 25px;" name="channelID" maxlength="255" required="true" />
    ...
    <div class="u8_form_row">
      <label >登录状态(0:开放/1:关闭)：</label>
      <input type="text" class="easyui-textbox" style="height: 25px;" name="openLoginFlag" prompt="关闭后，登录返回错误" maxlength="255" novalidate />
    </div>
    <div class="u8_form_row">
      <label >注册状态(0:开放/1:关闭)：</label>
      <input type="text" class="easyui-textbox" style="height: 25px;" name="openRegisterFlag" prompt="关闭后，注册返回错误" maxlength="255" novalidate />
    </div>
    <div class="u8_form_row">
      <label >CPID：</label>
