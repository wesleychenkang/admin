...
public interface GameDao {
	...
	List<Game> queryGames(@Param("appId") Integer appId, @Param("appName") String appName, @Param("currIndex") Integer currIndex,
			@Param("pageSize") Integer pageSize,@Param ("perrsion")List<String> perrsion);
